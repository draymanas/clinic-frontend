...
const medicalSpecialties = [
  ...
  "جراحة عامه","امراض دم","قلب وأوعية دموية", "مخ وأعصاب", "نسا وتوليد", "تخاطب", "كلى", "نفسي"
];
...
const specialties = [
    ...
    // باقي التخصصات...
    { name: 'نساوتوليد', icon: '🤰', count: 1026 },
    ...
    { name: 'كبد وجهاز هضمي ', icon: '🫃', count: 459 },
    ...
    { name: 'جراحة مخ واعصاب', icon: '🧠', count: 211 },
