...
export const DirectBooking = () => {
  ...
  // 🌟 إذا فتح الزائر الرابط المختصر /d/:id في المتصفح يتم توجيهه تلقائياً إلى رابط الـ SEO الكامل
  useEffect(() => {
  ...
  useEffect(() => {
    if (doctor) {
      ...
      metaDesc.setAttribute('content', pageDescription);
        // 👇👇 أضف هذا الجزء الجديد هنا (إضافة فقط) 👇👇
      // 🌟 تثبيت رابط Canonical الكامل لجوجل
